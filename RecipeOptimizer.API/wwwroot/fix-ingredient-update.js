// This script fixes the ingredient update functionality
document.addEventListener('DOMContentLoaded', function() {
    // Wait for the DOM to be fully loaded
    setTimeout(function() {
        // Override the loadRecipes function to include edit and delete buttons
        ...
        window.loadRecipes = function() {
            ...
            // Sort recipes by serving size (highest to lowest)
            recipesArray.sort((a, b) => {
                const servingA = a.servingSize || 0;
                const servingB = b.servingSize || 0;
                return servingB - servingA; // Descending order
            });
            ...
            if (recipesArray.length === 0) {
                ...
                return;
                    ...
                    recipesArray.forEach(recipe => {
                        ...
                        // Store recipe ingredients for later use
